...
public class SupplierController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Supplier> retrieveSupplierById(@PathVariable final String id) throws Exception {
        final Supplier supplier = suppliersService.retrieveSupplierById(Long.parseLong(id));
        return new ResponseEntity<Supplier>(supplier, HttpStatus.OK);
    }

    @GetMapping("/name/{name}")
    public ResponseEntity<List<Supplier>> retrieveSupplierByName(@PathVariable final String name) throws Exception {
    ...
    public ResponseEntity<Supplier> retrieveSupplierByCpfCnpj(@PathVariable final String cpfcnpj) throws Exception {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteSupplier(@PathVariable final String id) throws Exception {
